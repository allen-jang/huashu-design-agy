---
name: huashu-design-agy
description: 화슈 Design - Antigravity Edition. HTML을 사용한 고해상도 프로토타입, 인터랙티브 데모, 슬라이드, 애니메이션, 디자인 변체(Tweaks) 탐색 + 디자인 방향성 추천 및 전문가 리뷰 제공. UX/애니메이터/슬라이드 디자이너/프로토타이퍼 역할을 수행하며 일반적인 AI 스타일을 방지합니다. 触发词：做原型、설계 데모, 디자인 데모, 프로토타입, PPT 제작, 슬라이드 덱, UI 디자인, 모션 그래픽, 60fps 애니메이션, 디자인 스타일, 전문가 리뷰.
---
